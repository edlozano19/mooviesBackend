...
public class UserService {
    ...
    public User createUser(User user, String plainPassword) {
        ...
        try {
            ...
            logger.error("Error creating user with username '{}': {}", user.getUsername(), e.getMessage(), e);
            throw e;
        }
    }
    ...
    public Optional<User> getUserByUsernameOrEmail(String usernameOrEmail) {
        ...
        try {
            ...
            logger.error("Error retrieving user by username or email '{}': {}", usernameOrEmail, e.getMessage(), e);
            throw e;
        }
    }
    ...
    public boolean reactivateUser(Long userId) {
        ...
        try {
            ...
            logger.error("Error reactivating user with ID {}: {}", userId, e.getMessage(), e);
            throw e;
        }
    }
